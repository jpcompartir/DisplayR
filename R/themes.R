...
#' @param index An optional numeric index or vector of indices to select specific colours from the Microsoft color palette.
...
#'
#' @param scale_type A character string specifying the type of scale, either "continuous" or "discrete". Default is "discrete".
#' @param index An optional numeric index or vector of indices to select specific colors from the SAMY color palette.
