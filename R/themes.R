...
#' Apply Microsoft Themed Color Scales and Aesthetics to ggplot2 Plots
#'
#' This function provides a convenient way to apply Microsoft themed color scales and aesthetics to ggplot2 plots.
...
#' @param index An optional numeric index or vector of indices to select specific colors from the Microsoft color palette.
#' @param direction An optional numeric value (1 or -1) specifying the direction of the color gradient for continuous scales. Default is 1.
...
#'
#' @return A list containing the ggplot2 theme, fill scale, and color scale.
#' @export
#'
#' @examples
#' \dontrun{
...
#'   }
theme_microsoft <- function(scale_type = c("discrete", "continuous"),
                            index = NULL,
                            direction = 1,
                            guide = 'legend',
                            fallback_font = "sans") {
