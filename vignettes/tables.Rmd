...
library(gt)
(my_gt <- df %>%
  JPackage::disp_gt_summary(date_var = date,
                            group_var = topic, 
...
The function will not inclkude the Volume x Time chart, but we will get a nice gradient fill for the Positive + Negative columns which we can export to PowerPoint.
