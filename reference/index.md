...
- [`dr_plot_vot_group()`](https://jpcompartir.github.io/DisplayR/reference/dr_plot_vot_group.md)
  : Quickly make a line plot of volume over time for a grouping variable
- [`dr_plot_sent()`](https://jpcompartir.github.io/DisplayR/reference/dr_plot_sent.md)
  : Create a sentiment distribution bar chart
- [`dr_plot_sent_group()`](https://jpcompartir.github.io/DisplayR/reference/dr_plot_sent_group.md)
  : Plot sentiment grouped by a certain variable.
- [`dr_plot_sent_vot()`](https://jpcompartir.github.io/DisplayR/reference/dr_plot_sent_vot.md)
...
- [`disp_flextable()`](https://jpcompartir.github.io/DisplayR/reference/disp_flextable.md)
  : Create a flextable for volume + sentiment with a gradient fill.
- [`disp_gt()`](https://jpcompartir.github.io/DisplayR/reference/disp_gt.md)
...
- [`disp_ms_vot_grouped()`](https://jpcompartir.github.io/DisplayR/reference/disp_ms_vot_grouped.md)
  : Display Time Series Chart of Grouped Data Volume
- [`disp_ms_sent_grouped()`](https://jpcompartir.github.io/DisplayR/reference/disp_ms_sent_grouped.md)
  : Display a Stacked Bar Chart of Sentiment Grouped by a Variable
- [`dr_mmlb_barchart()`](https://jpcompartir.github.io/DisplayR/reference/dr_mmlb_barchart.md)
  : Create a stacked bar chart for Microsoft's Making My Life Better
  classification
...
- [`disp_add_slide()`](https://jpcompartir.github.io/DisplayR/reference/disp_add_slide.md)
...
- [`dr_theme_black()`](https://jpcompartir.github.io/DisplayR/reference/dr_theme_black.md)
  : theme_black
- [`dr_theme_capture()`](https://jpcompartir.github.io/DisplayR/reference/dr_theme_capture.md)
  : Apply Capture Intelligence themed colour scales and aesthetics to
  ggplot2 plots
- [`dr_theme_microsoft()`](https://jpcompartir.github.io/DisplayR/reference/dr_theme_microsoft.md)
  : Apply Microsoft Themed Colour Scales and Aesthetics to ggplot2 Plots
- [`dr_theme_samy()`](https://jpcompartir.github.io/DisplayR/reference/dr_theme_samy.md)
  : Apply SAMY Themed Colour Scales and Aesthetics to ggplot2 Plots
- [`dr_theme_share()`](https://jpcompartir.github.io/DisplayR/reference/dr_theme_share.md)
  : Apply share Themed colour Scales and Aesthetics to ggplot2 Plots

## Brand Styling Utilities

Apply brand styling and logo to Quarto documents
...
- [`dr_add_brand()`](https://jpcompartir.github.io/DisplayR/reference/dr_add_brand.md)
